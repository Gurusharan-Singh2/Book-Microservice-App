...
// User registration
export const registerUser = catchAsync(async (req: any, res: Response, next: NextFunction) => {
...
// User login
export const loginUser = catchAsync(async (req: any, res: Response, next: NextFunction) => {
